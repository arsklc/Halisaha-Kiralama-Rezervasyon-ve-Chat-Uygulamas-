...
class kiraciGirisEkrani : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_kiraci_giris_ekrani, container, false)

        emailEditText = view.findViewById(R.id.kiraciMail)
        passwordEditText = view.findViewById(R.id.kiraciSifre)

        val loginButton = view.findViewById<Button>(R.id.kiraciGirisYap)
        ...
        val signUpButton = view.findViewById<Button>(R.id.kiraciUyeOl)
        signUpButton.setOnClickListener {
            val nextFragment = kiraciUyeOlma()
        ...
        val forgotPasswordButton = view.findViewById<Button>(R.id.kiraciSifremiUnuttum)
