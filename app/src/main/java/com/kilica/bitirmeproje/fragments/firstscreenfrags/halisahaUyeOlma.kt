...
class halisahaUyeOlma : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_halisaha_uye_olma, container, false)
        ...
        val registerButton = view.findViewById<Button>(R.id.sahaKayit)
                                        ...
                                        auth.signInWithEmailAndPassword(email, password)
                                            .addOnCompleteListener { signInTask ->
                                                if (signInTask.isSuccessful) {
                                                    ...
                                                    Toast.makeText(requireContext(), "Giriş başarısız: ${signInTask.exception?.message}", Toast.LENGTH_SHORT).show()
                                                }
                                            }
                                    }
